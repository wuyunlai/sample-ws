 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://helloworld.ws.sample.wuyl.cn/", wsdlLocation = "http://localhost:80/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://helloworld.ws.sample.wuyl.cn/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:80/hello?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://helloworld.ws.sample.wuyl.cn/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloworld.ws.sample.wuyl.cn/", "HelloWorldPort"), HelloWorld.class, features);
    }
